...
class GroupOperation: Operation {
    ...
    */
    ...
    func operationDidFinish(operation: Foundation.Operation, withErrors errors: [Error]) {
...
extension GroupOperation: OperationQueueDelegate {
    ...
    final func operationQueue(operationQueue: OperationQueue, operationDidFinish operation: Foundation.Operation, withErrors errors: [Error]) {
